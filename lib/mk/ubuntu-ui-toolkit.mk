...
built.tag: qmake_prepared.tag
	...
	$(VERBOSE)cd $(CURDIR)/install/qt/qml/Ubuntu/PerformanceMetrics && \
		$(STRIP) libUbuntuPerformanceMetrics.lib.so -o libUbuntuPerformanceMetrics.lib.so.stripped
	...
	$(VERBOSE)ln -sf $(CURDIR)/install/qt/qml/Ubuntu/PerformanceMetrics/libUbuntuPerformanceMetrics.lib.so.stripped $(PWD)/bin/libUbuntuPerformanceMetrics.lib.so
	...
	$(VERBOSE)ln -sf $(CURDIR)/install/qt/qml/Ubuntu/PerformanceMetrics/libUbuntuPerformanceMetrics.lib.so $(PWD)/debug/
