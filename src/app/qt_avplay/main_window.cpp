	...
	_control_bar(_nitpicker_session_component.input_component())
{
	...
	/*
	 * The main window must be visible before avplay requests the framebuffer
	 * session which goes to Nitpicker, because the parent view of the new
	 * Nitpicker view is part of the QNitpickerPlatformWindow object, which is
	 * created when the main window becomes visible.
	 */
